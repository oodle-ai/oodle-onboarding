...
# persistent (non-Convox) group that the OTel collector will then keep appending to.
#
...
#
# Then: set CW_LOG_GROUP=<dest-persistent-group> on the agent, `make deploy`,
# and `make enable-syslog`.
#
